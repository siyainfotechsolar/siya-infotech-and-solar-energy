...
copy /Y "build\app\outputs\flutter-apk\app-release.apk" "releases\Siya-Solar-Staff-v1.0.5.apk"
copy /Y "build\app\outputs\flutter-apk\app-release.apk" "releases\latest\Siya-Solar-Staff-latest.apk"
copy /Y "build\app\outputs\flutter-apk\app-release.apk" "release-page\releases\Siya-Solar-Staff-v1.0.5.apk"
...
call dart run scripts/update_release_v1_0_5.dart

echo ====================================================================
echo SUCCESS! Release APK generated and copied to:
echo  - releases\Siya-Solar-Staff-v1.0.5.apk
